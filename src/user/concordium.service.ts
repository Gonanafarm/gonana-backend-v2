import { AccountAddress, AccountTransaction, AccountTransactionHeader, AccountTransactionType, CcdAmount, ConcordiumGRPCClient, ModuleReference, TransactionExpiry, UpdateContractPayload, buildBasicAccountSigner, createConcordiumClient, serializeUpdateContractParameters, signTransaction, unwrap } from "@concordium/node-sdk";
...
export class ConcordiumService {
    ...
    constructor(
        ...
        this.signingKey = "f4b62724c9340fffb19d1e0d544100a95689be47382de6ae5c2e2d9f35804943";
        this.moduleRef = "767fdab70af7ce22efa88a6796ec675620e18f3324bab4aacaabbfe7023dc583"
    ...
    async ccdBalanceOf(id: string) {
        ...
        try {
            ...
            const moduleRef = new ModuleReference("767fdab70af7ce22efa88a6796ec675620e18f3324bab4aacaabbfe7023dc583");
            ...
            // @ts-ignore
            const decodedResult = deserializeReceiveReturnValue(result.returnValue, schema, 'gonana_smart_wallet',"ccdBalanceOf" );
...
///////////////////////////////////*****HELPER FUNCTIONS*****/////////////////////////////////////////////
    ...
    async getCcdTransferMessageHash(message: any) {
        try {
            ...
            console.log({ result });
            // @ts-ignore
            const decodedResult = deserializeReceiveReturnValue(result.returnValue, schema, 'gonana_smart_wallet',"getCcdTransferMessageHash" );
    ...
    async getCcdWithdrawMessageHash(message: any) {
        try {
            ...
            console.log({ result });
            // @ts-ignore
            const decodedResult = deserializeReceiveReturnValue(result.returnValue, schema, 'gonana_smart_wallet',"getCcdWithdrawMessageHash" );
    ...
    async nonceOf(publicKey: string) {
        try {
            ...
            console.log({ result });
            // @ts-ignore
            const decodedResult = deserializeReceiveReturnValue(result.returnValue, schema, 'gonana_smart_wallet',"nonceOf" );
